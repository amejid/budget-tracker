...
RSpec.describe 'Categories', type: :system, js: true do
  describe 'index page' do
    before(:example) do
      @user = User.create(name: 'Amejid', email: 'amejid@mail.com', password: '123456')
      sign_in @user
    ...
    it 'renders total expenses of the category' do
  ...
  describe 'show page' do
    before(:example) do
      ...
      @expense = Expense.create(author: @user, name: 'Movie Ticket', amount: 26, category_ids: [@category.id])
    ...
    it 'renders total expenses of that category' do
      expect(page).to have_content(@category.expenses.sum(:amount))
    end
    ...
    it 'redirects to create new expense page' do
